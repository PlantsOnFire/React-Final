...
function RandomCountryPage ({worldData}) {
  const [displayCountry, setDisplayCountry] = useState(worldData[Math.floor(Math.random()*250)]);
  ...
  return (
    <main>
      ...
      <div className='container form-container p-5' id='display-country'>
        ...
        <SearchResult displayCountry={displayCountry}/>
      </div>
    </main>
  )
}
